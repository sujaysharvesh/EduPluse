...
public class JwtUtils {
    ...
    public String generateAccessToken(UUID userId, String email, String username, String role, String schoolId) {
        Date now = new Date();
    ...
    public String generateRefreshToken(UUID userId, String email, String username, String role, String schoolId) {
        Date now = new Date();
